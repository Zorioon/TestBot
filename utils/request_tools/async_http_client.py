...
class AsyncHttpClient:
    ...
    def __init__(self, base_url: Optional[str] = None, default_headers: Dict[str, str] = {}, verify_ssl: bool = False, timeout: Union[float, httpx.Timeout] = 60.0):
        """
        初始化异步HTTP客户端
        ...
        for file_path in files_to_upload:
            ...
            for attempt in range(1, max_retries + 1):
                try:
                    ...
                    log.exception(f"{filename} 上传失败，第 {attempt} 次重试")
